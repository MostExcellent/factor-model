...
def process_factors(df):
    ...
    df_copy = df.copy()
    df_copy['MarketPremium'] = df_copy['ForwardReturn'] # Will add risk free rate when I get that working
...
if os.path.isfile(csv_file):
    ...
    df = df.dropna(subset=['LastPrice', 'MarketCap', 'BookValuePerShare', 'ROE', 'FreeCashFlow'])
else:
...
print(df_grouped[['MarketPremium','ForwardReturn','Size', 'Value', 'Profitability', 'Investment']].isnull().sum())
